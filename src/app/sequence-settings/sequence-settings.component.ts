...
export class SequenceSettingsComponent implements OnInit {
  ...
  ngOnInit() {
    this.settingForm = this.fb.group({
      ...
      SEQUENCE_PRIMER: ['', this.sfvService.nucleotideSequenceValidator("SEQUENCE_PRIMER")],
      PRIMER_PICK_INTERNAL_OLIGO: [false, this.sfvService.pickInternalOligoValidator()],
      SEQUENCE_INTERNAL_OLIGO: ['', this.sfvService.nucleotideSequenceValidator("SEQUENCE_PRIMER")],
      PRIMER_PICK_RIGHT_PRIMER: [true, this.sfvService.pickRightPrimerValidator()],
      SEQUENCE_PRIMER_REVCOMP: ['', this.sfvService.nucleotideSequenceValidator("SEQUENCE_PRIMER")],
